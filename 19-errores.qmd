...
La solución es sencilla: escribe tu pregunta. Léela. Pregúntate qué *tipo* de respuesta necesitas. Si necesitas "cuántos," usa números. Si necesitas "cómo lo viven," usa palabras. Si necesitas ambos, usa métodos mixtos (ver @enfoques).
