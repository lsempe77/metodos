...
El lenguaje inclusivo me vuelve loco. Me pongo de mal humor al tener que escribir las/los, etc. Me cuenta leerlo también. Así que usaré la norma actual de la Real Academia de la Lengua donde el masculino es genérico [@rae]. (Aquí una importante enseñanza sobre la investigación: las afirmaciones deben ser fundamentadas, y para ello, se ha de recurrir a la literatura académica previa, a la autoridad -como en este caso-, o a la evidencia empírica.). Espero que nadie se ofenda y no me juzguen por ello. Prometo no ser un machista.
...
Entonces es común encontrar que alguien que está de acuerdo (o en desacuerdo) con algo, lo estudia y confirma su postura. Y se lo comunica, con un lenguaje gregario, a los de su misma tribu. Se pierde la capacidad de asombro, pensar la pregunta de investigación como un rompecabezar a ser resuelto, con la posiblidad de arriesgarse a estar equivocado (al menos parcialmente). Aquí hay un poco de lo que Khun explica magistralmente en cuanto a la tensión de cambiar de paradigmas científicos [@kuhn1996] (pero bueno, este es un libro de metodología y no de filosofía, pero deberías leer el librito o por lo menos googlearlo en wikipedia).

3)

Ah, y no tengo intenciones de publicar el texto así que no tengo que cuidar el lenguaje formal de un manual académico (supongo que se habrán dado cuenta de ello). Así que esto le da la oportunidad al lector de distraerse en un libro poco técnico sobre una materia que suele ser bien aburrida. Ojalá que le cambie en algo su perspectiva.
